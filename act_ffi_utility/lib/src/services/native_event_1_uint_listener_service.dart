...
typedef _Native1UintCallback = ffi.Void Function(ffi.UnsignedInt param);
...
class NativeEvent1UintListenerService<Result extends MixinResultStatus, ParsedObject>
    extends AbsNativeEventListenerService<Result, _Native1UintCallback, ParsedObject> {
  ...
  @override
  ffi.NativeCallable<_Native1UintCallback> getNativeCallback() =>
      ffi.NativeCallable<_Native1UintCallback>.listener(_onNativeEvent);
