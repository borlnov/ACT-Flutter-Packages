...
class ValueKeeperOnStream<T, Listened> extends ValueKeeper<T>
    with MixinDisposableValueKeeper<T>, MixinValueKeeperOnStreamUpdate<T, Listened> {
  ...
  /// available.
  ValueKeeperOnStream.lateInitStream({
    required T initialValue,
    required this.parserCallback,
  }) : super(value: initialValue);
}
